...
?>
<!-- Sidebar -->
<aside class="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-slate-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0"
       :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'">
    <div class="flex flex-col h-full">
        <!-- Logo -->
        <div class="flex items-center gap-3 px-6 h-16 border-b border-slate-100">
            <div class="flex items-center justify-center w-9 h-9 bg-brand-600 rounded-xl shadow-md shadow-brand-200">
            ...
            <div>
                <h1 class="text-base font-bold text-slate-800 tracking-tight">JointaSoft</h1>
                <p class="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Receipt System</p>
            </div>
            <!-- Close button (mobile) -->
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto scrollbar-thin">
            ...
            <a href="<?= url('/dashboard') ?>" id="nav-dashboard"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/dashboard') ?>">
            ...
            <!-- New Sale -->
            <a href="<?= url('/sales/create') ?>" id="nav-new-sale"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/sales') ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- My Records -->
            <a href="<?= url('/records') ?>" id="nav-records"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/records') ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- My Ledger -->
            <a href="<?= url('/ledger') ?>" id="nav-ledger"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/ledger') ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Contributions -->
            <a href="<?= url('/contributions') ?>" id="nav-contributions"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/contributions') ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if ($isAdmin): ?>
                <p class="px-3 pt-4 text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">Administration</p>

                <!-- Office Funds -->
                <a href="<?= url('/funds') ?>" id="nav-funds"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/funds') ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Admin Review -->
                <a href="<?= url('/review') ?>" id="nav-review"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/review') ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Members -->
                <a href="<?= url('/members') ?>" id="nav-members"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/members') ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Reports -->
                <a href="<?= url('/reports') ?>" id="nav-reports"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/reports') ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?= url('/settings') ?>" id="nav-settings"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 <?= activeClass('/settings') ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-3 border-t border-slate-100">
            <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-50">
                <div class="flex items-center justify-center w-9 h-9 rounded-full bg-brand-100 text-brand-700 font-semibold text-sm">
                    <?= e(mb_strtoupper(mb_substr($user['name'] ?? 'U', 0, 1))) ?>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-slate-800 truncate"><?= e($user['name'] ?? 'User') ?></p>
                    <p class="text-xs text-slate-400 capitalize"><?= e($user['role'] ?? 'staff') ?></p>
                </div>
                <a href="<?= url('/logout') ?>" title="Sign out" class="text-slate-400 hover:text-red-500 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
